...
from .views import table_view, GameViewSet, PlayerViewSet, CommunityCardSet
...
router.register(r'api/community_cards', CommunityCardSet, basename='community_cards')
# router.register(r'api/player_cards', PlayerCardSet, basename='player_cards')
